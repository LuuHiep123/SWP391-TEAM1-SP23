    ...
    return (
        <div className='TrangGioiThieu'>
            <div className='col-md-5'>
                <span className='dangcapgioithieu'>Đẳng cấp</span>
                <span className='dangcapgioithieu'>viet</span>
                <span className='dangcapgioithieu'>villas</span>
                <ContentSection
            ...
            <div className='col-md-7'>
                <img src='/logogioithieu/sec_about_1_image.png' />
            </div>
        </div>
    );
};
